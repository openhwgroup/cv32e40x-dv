...
module cv32e40x_tb_wrapper
    ...
    // irq signals (driven by mm_ram: CLINT timer + Sail interrupt generator)
    logic [31:0]                  irq;
    logic [4:0]                   irq_id_in;
    logic                         irq_ack;
...
`endif
    ...
    cv32e40x_core_i
        (
         ...
         // Basic interrupt architecture (driven by mm_ram, not tied off, so
         // ACT4 InterruptsSm tests actually fire)
         .irq_i                  ( irq                   ),
