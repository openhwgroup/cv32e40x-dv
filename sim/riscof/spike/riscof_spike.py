...
#          cmd = self.compile_cmd.format(testentry['isa'].lower(), self.xlen, test, elf, compile_macros)
          cmd = self.compile_cmd.format(self.isa, self.xlen, test, elf, compile_macros)
	  ...
	  # echo statement.
          if self.target_run:
            ...
            simcmd = self.dut_exe
            simcmd += ' --misaligned' # TODO: Make this configurable
            simcmd += ' --isa={0} +signature={1} +signature-granularity=4 {2}'.format(self.isa, sig_file, elf)
          else:
            simcmd = 'echo "NO RUN"'
