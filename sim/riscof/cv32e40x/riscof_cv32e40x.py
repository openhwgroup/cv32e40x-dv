...
class cv32e40x(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","cv32e40x")
        ...
        #check CV_SIMULATOR env variable
        self.simulator_var = os.environ['CV_SIMULATOR']
    ...
    def build(self, isa_yaml, platform_yaml):
        ...
        # for cv32e40x start building the '--isa' argument. the self.isa is dut name specific and may not be
        # useful for all DUTs
    ...
    def runTests(self, testList):
        ...
        for testname in testList:
            ...
            simdir = 'cd {0}/cv32e40x/sim/{1}'.format(self.tbpath, self.dut_exe)
